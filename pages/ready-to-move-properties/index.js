...
// Fetch Remaining Properties in the Background
  ...
  return (
    <>
      {/* <CommonBanner title={readyMovePage.title} meta={meta} /> */}
      <div className="container">
        <div className='shadow-sm bg-white px-3 my-3'>
        <div className="row py-3">
          <div className="col-md-6">
            <h4>{readyMovePage.title}</h4>
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <div className={`${styles.left_card}`}>
              {readyMovePage && <div dangerouslySetInnerHTML={{ __html: readyMovePage.description }} />}
              <LatestBlog />
              <LatestProperty />
            </div>
          </div>
...
export const getStaticProps = async () => {
  try {
    ...
    const meta = await fetchData(API_URLS.META,{slug:'ready-to-move-properties',columns: 'title,description,thumbnail,slug'});
    return {
      props: { 
    ...
    return { props: { property: { data: [], total: 0 }, readyMovePage: [],meta:[] }, revalidate: 10 };
  }
};
